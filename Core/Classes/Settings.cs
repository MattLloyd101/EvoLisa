namespace GenArt.Classes
{
    ...
    {
        public static bool allowPolygons = false;
        public static bool allowCircles = true;
        ...
        public static int ActiveCircleSizeMidMutationRate = 1500;
        ...
        private int alphaRangeMax = 255;
        private int alphaRangeMin = 1;
        ...
        private int pointsMax = ActivePointsPerPolygonMax;
        private int pointsMin;
        private int pointsPerPolygonMax = 16;
        private int pointsPerPolygonMin = 3;
        private int polygonsMax = 20480;
        ...
        public static int ActiveRotationMutationRate = 1500;
        public static bool spawnMany = false;
